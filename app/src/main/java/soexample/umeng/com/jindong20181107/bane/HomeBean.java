...
public class HomeBean {
    ...
    public static class DataBean {
        ...
        public static class MiaoshaBean {
            ...
            public static MiaoshaBean objectFromData(String str) {

                return new Gson().fromJson(str, MiaoshaBean.class);
            }
        ...
        public static class FenleiBean {
            ...
            public static FenleiBean objectFromData(String str) {

                return new Gson().fromJson(str, FenleiBean.class);
            }
